...
(custom-autoload (quote tramp-default-host-alist) "tramp" t)
...
(autoload (quote tramp-mode-string-to-int) "tramp" "\
Converts a ten-letter `drwxrwxrwx'-style mode string into mode bits.

\(fn MODE-STRING)" nil nil)

(autoload (quote tramp-file-mode-from-int) "tramp" "\
Turn an integer representing a file mode into an ls(1)-like string.

\(fn MODE)" nil nil)

(autoload (quote tramp-get-local-uid) "tramp" "\
Not documented

\(fn ID-FORMAT)" nil nil)

(autoload (quote tramp-get-local-gid) "tramp" "\
Not documented

\(fn ID-FORMAT)" nil nil)

(autoload (quote tramp-check-cached-permissions) "tramp" "\
...
(autoload (quote tramp-local-host-p) "tramp" "\
...
;;;;;;  "tramp-adb" "tramp-adb.el" (20983 34404))
;;; Generated autoloads from tramp-adb.el

(defconst tramp-adb-method "adb" "\
*When this method name is used, forward all calls to Android Debug Bridge.")

(add-to-list (quote tramp-methods) (\` ((\, tramp-adb-method) (tramp-tmpdir "/data/local/tmp"))))

(add-to-list (quote tramp-default-host-alist) (\` ((\, tramp-adb-method) nil "")))

(eval-after-load (quote tramp) (quote (tramp-set-completion-function tramp-adb-method (quote ((tramp-adb-parse-device-names ""))))))

(add-to-list (quote tramp-foreign-file-name-handler-alist) (cons (quote tramp-adb-file-name-p) (quote tramp-adb-file-name-handler)))
...
(autoload (quote tramp-adb-file-name-handler) "tramp-adb" "\
...
(autoload (quote tramp-adb-parse-device-names) "tramp-adb" "\
...
;;;;;;  "tramp-cache" "tramp-cache.el" (20983 34404))
...
(custom-autoload (quote tramp-connection-properties) "tramp-cache" t)
...
(autoload (quote tramp-connection-property-p) "tramp-cache" "\
...
;;;;;;  tramp-cleanup-connection) "tramp-cmds" "tramp-cmds.el" (20983
;;;;;;  34404))
...
(when (featurep (quote xemacs)) (add-to-list (quote tramp-methods) (cons tramp-efs-method nil)) (add-to-list (quote tramp-default-method-alist) (list "\\`ftp\\." nil tramp-efs-method)) (add-to-list (quote tramp-default-method-alist) (list nil "\\`\\(anonymous\\|ftp\\)\\'" tramp-efs-method)))
...
;;;;;;  "tramp-gvfs" "tramp-gvfs.el" (20983 34404))
...
(add-to-list (quote tramp-methods) (quote ("sftp" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("%c") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "sftp") (tramp-copy-args ("%c")))))

(add-to-list (quote tramp-methods) (quote ("rsync" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("%c") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "rsync") (tramp-copy-args (("-t" "%k") ("-r"))) (tramp-copy-env (("RSYNC_RSH") ("ssh" "%c"))) (tramp-copy-keep-date t) (tramp-copy-keep-tmpfile t) (tramp-copy-recursive t))))
...
(add-to-list (quote tramp-methods) (quote ("ssh" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("%c") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-gw-args (("-o" "GlobalKnownHostsFile=/dev/null") ("-o" "UserKnownHostsFile=/dev/null") ("-o" "StrictHostKeyChecking=no"))) (tramp-default-port 22))))
...
(add-to-list (quote tramp-methods) (quote ("plink" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-default-port 22))))
...
(add-to-list (quote tramp-methods) (quote ("pscp" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "pscp") (tramp-copy-args (("-l" "%u") ("-P" "%p") ("-scp") ("-p" "%k") ("-q") ("-r"))) (tramp-copy-keep-date t) (tramp-copy-recursive t) (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("psftp" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "pscp") (tramp-copy-args (("-l" "%u") ("-P" "%p") ("-sftp") ("-p" "%k") ("-q") ("-r"))) (tramp-copy-keep-date t) (tramp-copy-recursive t))))
...
(add-to-list (quote tramp-default-user-alist) (\` ((\, (concat "\\`" (regexp-opt (quote ("rcp" "remcp" "rsh" "telnet" "krlogin" "fcp"))) "\\'")) nil (\, (user-login-name)))))
...
(defconst tramp-completion-function-alist-putty (\` ((tramp-parse-putty (\, (if (memq system-type (quote (windows-nt))) "HKEY_CURRENT_USER\\Software\\SimonTatham\\PuTTY\\Sessions" "~/.putty/sessions"))))) "\
...
(defvar tramp-remote-path (quote (tramp-default-remote-path "/bin" "/usr/bin" "/sbin" "/usr/sbin" "/usr/local/bin" "/usr/local/sbin" "/local/bin" "/local/freeware/bin" "/local/gnu/bin" "/usr/freeware/bin" "/usr/pkg/bin" "/usr/contrib/bin" "/opt/bin" "/opt/sbin" "/opt/local/bin")) "\
...
(defvar tramp-remote-process-environment (\` ("HISTFILE=$HOME/.tramp_history" "HISTSIZE=1" "LC_ALL=C" (\, (format "TERM=%s" tramp-terminal-type)) "EMACS=t" (\, (format "INSIDE_EMACS='%s,tramp:%s'" emacs-version tramp-version)) "CDPATH=" "HISTORY=" "MAIL=" "MAILCHECK=" "MAILPATH=" "PAGER=\"\"" "autocorrect=" "correct=")) "\
...
(custom-autoload (quote tramp-remote-process-environment) "tramp-sh" t)
...
;;;***

;;;### (autoloads nil "trampver" "trampver.el" (20983 34438))
...
;;;***

;;;### (autoloads nil nil ("password.el" "socks.el" "tramp-compat.el")
;;;;;;  (20983 34438 943936))
